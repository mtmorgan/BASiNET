...
Parameters: 
<div style="text-align: justify">
			word - Define the number of nitrogenous bases that formed a word.

			step - Defines the distance that will be traversed in the sequence for the formation of a new connection.
